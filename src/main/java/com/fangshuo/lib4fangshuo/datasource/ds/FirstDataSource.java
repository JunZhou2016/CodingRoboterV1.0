 ...
 * 
 * @ClassName: FirstDataSource.java
 * @Description: 第一个自定义的数据源;
 * 
 * @version: v1.0.0
 * @author: JunZhou
 * @Email: 1769676159@qq.com
 * @Site: CERNO
 * @date: 2018年10月8日 下午9:25:24
 */

public class FirstDataSource extends DruidDataSource {
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 1L;

	public FirstDataSource() {
		Environment env = SpringUtils.getBean(Environment.class);
		this.setUrl(env.getProperty("spring.first.datasource.url"));
