 ...
 * 
 * @ClassName: QQEmailUtils.java
 * @Description: qq邮箱操作相关的工具类;
 * 
 * @version: v1.0.0
 * @author: JunZhou
 * @Email: 1769676159@qq.com
 * @Site: CERNO
 * @date: 2018年10月13日 下午10:15:36
 */
public class QQEmailUtils {
	// 发件人的 邮箱 和 密码（替换为自己的邮箱和密码）
	public static String myEmailAccount = "1769676159@qq.com";
	public static String myEmailPassword = "xnnkaqebjioocfdh";// 这个密码不是QQ密码或者邮箱密码，要验证的。自己百度
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "3040237357@qq.com";
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
		...
		DataHandler dh = new DataHandler(new FileDataSource("D:\\doc\\icerno.png")); // 读取本地文件
		...
		DataHandler dh2 = new DataHandler(new FileDataSource("D:\\doc\\excel.xls")); // 读取本地文件
